#ifndef AnalogMicroNavigator_h
#define AnalogMicroNavigator_h
...
class KeypadChannel
{
  ...
  const int s_iAutoRepeatDelay = 1000;
...
public:
  ...
  bool getAndDispatchKey(unsigned long ulNow, AnalogMicroNavigator *p, uint8_t uKeyOtherChannel);
...
public:
  ...
  bool isKeyDown(uint8_t vks)
  {
    return ((vks & m_ch[0].m_bOldKey) != 0) || ((vks & m_ch[1].m_bOldKey) != 0);
  }
